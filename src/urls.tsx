...
import ithink from "./images/ithink.png";
...
export const urls = [
  ...
  },
  {
    title: "Instagram",
    highlight: "Popular",
    link: "https://www.instagram.com/sh.kholikov",
    icon: (
      <svg
        aria-hidden="true"
        className="h-5"
  ...
  },
  {
    title: "Linkedin",
    highlight: "",
    link: "https://www.linkedin.com/in/shkholikov",
    icon: (
      <svg
        aria-hidden="true"
        className="h-5"
  ...
  },
  {
    title: "Facebook",
    highlight: "",
    link: "https://www.facebook.com/kholikovsh",
    icon: (
      <svg
        aria-hidden="true"
        className="h-5"
